...
1. [Fork](https://github.com/benbalter/wordpress-to-jekyll-exporter/fork) and clone the project
...
6. Push to your fork and [submit a pull request](https://github.com/benbalter/wordpress-to-jekyll-exporter/compare) describing your change
